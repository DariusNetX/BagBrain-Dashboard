    ...
    <>
      ...
      <div className="fixed z-40" style={{ top: '1rem', left: '1rem' }}>
        <div className="relative">
          <Link href="/iq">
            <button 
              className="viral-button-text bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-bold px-4 py-2 md:px-8 md:py-4 rounded-full shadow-2xl border-2 border-purple-500/50 hover:border-purple-400/80 transition-all duration-300 hover:scale-105 text-sm md:text-base"
          ...
          <div className="section-container bg-black/50 backdrop-blur-sm border border-blue-500/30 rounded-xl p-6 text-center enhanced-hover">
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
              ...
              <a
                ...
                className="btn-lg group relative inline-flex items-center justify-center gap-3 px-8 py-4 bg-transparent text-blue-400 font-bold rounded-lg border-2 border-blue-400/50 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 hover:-translate-y-1 hover:bg-blue-500/10 hover:border-blue-400/70 glow-text uppercase tracking-wide text-lg"
              >
